...
func (x *Blog) Reset() {
	*x = Blog{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbs_blog_proto_msgTypes[0]
...
func (*Blog) Descriptor() ([]byte, []int) {
	return file_pbs_blog_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateBlogRequest) Reset() {
	*x = CreateBlogRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbs_blog_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateBlogRequest) Descriptor() ([]byte, []int) {
	return file_pbs_blog_proto_rawDescGZIP(), []int{1}
}
...
func (x *CreateBlogResponse) Reset() {
	*x = CreateBlogResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbs_blog_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateBlogResponse) Descriptor() ([]byte, []int) {
	return file_pbs_blog_proto_rawDescGZIP(), []int{2}
}
...
var File_pbs_blog_proto protoreflect.FileDescriptor

var file_pbs_blog_proto_rawDesc = []byte{
	0x0a, 0x0e, 0x70, 0x62, 0x73, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x1a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	...
	0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1,
	...
	0x41, 0x74, 0x22, 0x56, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x42, 0x6c, 0x6f, 0x67,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09, 0xe2, 0xdf, 0x1f, 0x05, 0x70, 0x03, 0x78, 0x80,
	0x01, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x20, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xe2, 0xdf, 0x1f, 0x02, 0x70,
	0x05, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x34, 0x0a, 0x12, 0x43, 0x72,
	...
	0x32, 0x4c, 0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x3d, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x17, 0x2e, 0x62, 0x6c, 0x6f, 0x67,
	...
	0x42, 0x6c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x05,
	0x5a, 0x03, 0x70, 0x62, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pbs_blog_proto_rawDescOnce sync.Once
	file_pbs_blog_proto_rawDescData = file_pbs_blog_proto_rawDesc
)

func file_pbs_blog_proto_rawDescGZIP() []byte {
	file_pbs_blog_proto_rawDescOnce.Do(func() {
		file_pbs_blog_proto_rawDescData = protoimpl.X.CompressGZIP(file_pbs_blog_proto_rawDescData)
	})
	return file_pbs_blog_proto_rawDescData
}

var file_pbs_blog_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pbs_blog_proto_goTypes = []interface{}{
	(*Blog)(nil),               // 0: blog.Blog
	(*CreateBlogRequest)(nil),  // 1: blog.CreateBlogRequest
	(*CreateBlogResponse)(nil), // 2: blog.CreateBlogResponse
}
var file_pbs_blog_proto_depIdxs = []int32{
	0, // 0: blog.CreateBlogResponse.blog:type_name -> blog.Blog
	1, // 1: blog.BlogService.Create:input_type -> blog.CreateBlogRequest
	2, // 2: blog.BlogService.Create:output_type -> blog.CreateBlogResponse
...
func init() { file_pbs_blog_proto_init() }
func file_pbs_blog_proto_init() {
	if File_pbs_blog_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pbs_blog_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Blog); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pbs_blog_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbs_blog_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pbs_blog_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pbs_blog_proto_goTypes,
		DependencyIndexes: file_pbs_blog_proto_depIdxs,
		MessageInfos:      file_pbs_blog_proto_msgTypes,
	}.Build()
	File_pbs_blog_proto = out.File
	file_pbs_blog_proto_rawDesc = nil
	file_pbs_blog_proto_goTypes = nil
	file_pbs_blog_proto_depIdxs = nil
}
